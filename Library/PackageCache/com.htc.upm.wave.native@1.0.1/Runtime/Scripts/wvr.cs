...
namespace Wave.Native
{
	...
	public class Interop
	{
		...
		public static WVR_Result WVR_GetEyeTracking(ref WVR_EyeTracking_t data, WVR_CoordinateSystem space)
		{
		...
		public static void WVR_ReleaseControllerModel(IntPtr ctrlerModel /* WVR_CtrlerModel* */)
		{
			WVR_Base.Instance.ReleaseControllerModel(ctrlerModel);
		}
        ...
        public class WVR_Base
		{
			...
			public virtual void ReleaseControllerModel(IntPtr ctrlerModel /* WVR_CtrlerModel* */)
			{
